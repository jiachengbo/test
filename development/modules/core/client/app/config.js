(function (window) {
  ...
  var service = {
    ...
    applicationModuleVendorDependencies: ['ngResource', 'ngAnimate', 'ngMessages', 'ui.router', 'ui.router.state.events',
      'ui.bootstrap', 'ngFileUpload', 'ui-notification',
      ...
      'treeControl', 'nvd3', 'ngDraggable', 'ngStorage',
      'ngSanitize', 'openlayers-directive'],
